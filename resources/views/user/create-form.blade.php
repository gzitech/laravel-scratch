...
<div class="form-group row">
    ...
    <div class="col-md-6">
        ...
        <input id="last_name" type="text" class="form-control" name="last_name" v-model="userCreateForm.last_name"
            :class="{'is-invalid': userCreateForm.errors.has('last_name')}" required autocomplete="last_name" autofocus>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        @vueif
        <input id="email" type="email" class="form-control" name="email" v-model="userCreateForm.email"
